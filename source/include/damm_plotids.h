...
// in trace.cpp
    ...
    const int DD_ENERGY1__TMAX    = 874;
    const int DD_TRACEMAX_TQDC    = 875;
    const int DD_TRACEMAX_TQDC2   = 876;
    } // trace namespace
    namespace misc {
